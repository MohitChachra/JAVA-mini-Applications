...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        File file=new File("C:\\Users\\Mohit Chachra\\Desktop\\startup weekend.docx");
        ...
        FileOutputStream fos=new FileOutputStream("C:\\Users\\Mohit Chachra\\Desktop\\startup weekend.pdf");
        int k;
        while((k=fis.read())!=-1){
            fos.write(k);
        }
